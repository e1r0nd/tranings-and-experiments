...
const Quotes: IQuotes[] = [
  ...
  },
  {
    ...
    quote: "Don't let perfection become procrastination. Do it now.",
  },
  {
    author: "Bill James",
    quote:
  ...
  { author: "Seneca", quote: "While we are postponing, life speeds by" },
  {
    author: "David Burns",
    quote:
  ...
  },
  {
    author: "@thomasfuchs",
    quote:
      "As a programmer, never underestimate your ability to " +
      "come up with ridiculously complex solutions for simple problems.",
  },
  {
