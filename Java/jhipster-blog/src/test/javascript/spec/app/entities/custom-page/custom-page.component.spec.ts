...
import { CustomPageComponent } from 'app/entities/custom-page/custom-page.component';
...
describe('Component Tests', () => {
  describe('CustomPage Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.customPages && comp.customPages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
